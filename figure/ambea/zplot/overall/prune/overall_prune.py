...
c = canvas(ctype, title='overall_prune', dimensions=[700, 150])


######################################real_time#################################

t = table(file='overall_prune.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.2, 5000], dimensions=[pictureWidthLong, 100], coord=[50,30], yscale='log10')
...
#          xlabelrotate=20,
        xaxisposition=0.2 * 0.75, #yauto=['','',0.5], 
        # xlabelshift=[0, -1],
...
series_list = ['ambea','mbea', 'imbea','fmbe', 'pmbe', 'oombe']
