...
c = canvas(ctype, title='load_balance_ea', dimensions=[400, 150])


######################################real_time#################################

t_1 = table(file='load_balance_ea_t.data')
t_2 = table(file='load_balance_ea_b.data')
t_3 = table(file = "load_balance_ea_w.data")
d = drawable(canvas=c, xrange=[0, 640],
