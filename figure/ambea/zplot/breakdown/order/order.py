...
c = canvas(ctype, title='order', dimensions=[400, 200])
...
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.002, 50000], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30], yscale='log10')

axis(drawable=d,style='y',ticstyle='in',
     doxmajortics=False,doymajortics=True,
     ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], 
              ['10', 10],['100', 100], ['1k', 1000],['10k',10000]],
     ticmajorsize = 3,         
...
#          xlabelrotate=20,
        xaxisposition=0.0003, #yauto=['','',0.5], 
        xlabelshift=[0, xlableShiftY],
         xlabelfontsize=xlabelTextSize,
         ylabelfontsize=ylabelTextSize,
         xtitlesize=xtitleTextSize,
         ytitlesize=ytitleTextSize,
         ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], ['10', 10],['100', 100], ['1k', 1000],['10k',10000]],
...
series_list = ['AmbeaFinder', 'AmbeaRand', 'AmbeaUC']
series_name = ['AMBEA-INC','AMBEA-RAND','AMBEA-UC']
...
#### legend
L.draw(canvas=c, coord=[d.left()+4, d.top()+10], skipnext=1, skipspace=91,
