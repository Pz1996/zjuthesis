...
c = canvas(ctype, title='parameters', dimensions=[400, 150])


######################################real_time#################################

t = table(file='parameters.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.005, 2000], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30], yscale='log10')

axis(drawable=d,style='y',ticstyle='in',
     doxmajortics=False,doymajortics=True,
     ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], 
...
#          xlabelrotate=20,
        ...
        xlabelshift=[0, xlableShiftY],
         ...
         ytitlesize=ytitleTextSize,
         ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], ['10', 10],['100', 100], ['1k', 1000]],#, ['INFI', 7200]],
        yauto = ['', '', 1], 
...
series_list = ['warp8', 'warp16', 'warp24', 'warp32']
series_name = ['GMBE(8)', 'GMBE(16)', 'GMBE(24)', 'GMBE(32)']
bgcolors    = ['white', 'white', 'white', 'white', 'white','lightgrey', 'lightgrey', 'black']
fillcolors  = fig_colors_light#['lightcyan', 'darkgreen', 'honeydew', 'lightyellow', 'white','black', 'black', 'black',]
tmp = fillcolors[0]
fillcolors[0] = fillcolors[1]
fillcolors[1] = 'lightcoral'
...
#p.function(drawable=d, function=lambda x: 1, xrange=[-0.6, t.getmax('rownumber')+0.6], linewidth=0.75, linecolor='red', linedash = [2, 2])
# max line
...
#### legend
L.draw(canvas=c, coord=[d.left()+4, d.top()+10], skipnext=1, skipspace=64,
