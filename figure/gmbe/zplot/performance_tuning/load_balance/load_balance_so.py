...
c = canvas(ctype, title='load_balance_so', dimensions=[400, 150])


######################################real_time#################################

t_1 = table(file='load_balance_so_t.data')
t_2 = table(file='load_balance_so_b.data')
t_3 = table(file = "load_balance_so_w.data")
d = drawable(canvas=c, xrange=[0, 300],
...
axis(drawable=d, style='box', ticstyle='out',
         doymajortics=False, doxmajortics=False,
         xminorticcnt=0, #doxminortics=True, #yminorticcnt=0,
