...
c = canvas(ctype, title='time_opt', dimensions=[400, 200])


######################################real_time#################################

t = table(file='time_opt.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[5, 300000], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30], yscale='log10')
