...
c = canvas(ctype, title='multi_scalability_Github', dimensions=[400, 200])
...
d = drawable(canvas=c, xrange=[-0.6, 4.2],
             yrange=[0, 210], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30])
