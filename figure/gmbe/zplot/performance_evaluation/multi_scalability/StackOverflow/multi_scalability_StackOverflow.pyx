...
c = canvas(ctype, title='multi_scalability_StackOverflow', dimensions=[400, 150])
...
axis(drawable=d, style='xy', ticstyle='in',
         ...
         ytitle='Running time (s)', doylabels=True,ytitleshift=[ytitleShiftX,0],
         linewidth=0.8, xtitleshift=[-12,4],
         #yaxisposition=1,
         #xaxisposition=0, yauto=['','',3],
#          xlabelrotate=20,
        xaxisposition=0, yauto=['','',10], 
        # xlabelshift=[0, -1],
         xlabelfontsize=9,
         ylabelfontsize=9,
         xtitlesize=9,
...
fillcolors  = ['lavenderblush', 'ivory', 'azure', 'honeydew', 'pink','lightyellow', 'lightblue', 'lightgreen',]
ngpus = 1
barwidthInit = 0.15
...
#### legend
L.draw(canvas=c, coord=[d.left()+92, d.top()-6], skipnext=2, skipspace=40,
    hspace=3, fontsize=8,  width=7, height=7 )
