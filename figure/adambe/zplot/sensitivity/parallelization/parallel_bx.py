...
c = canvas(ctype, 'parallel_bx', dimensions=[400, 300])

t = table(file='parallel_bx.data')

# print(min_value)

d = drawable(canvas=c, xrange=[3, 120],
             yrange=[8, 20000], dimensions=[pictureWidthMini, pictureHeightMini], coord=[40,30], yscale='log10', xscale='log2')
...
L.draw(canvas=c, coord=[d.left()+3, d.top()+10], width=5, height=5, fontsize=legendTextSize, skipnext=1, skipspace=74)
L_line.draw(canvas=c, coord=[d.left(), d.top()+10], width=10, height=15, fontsize=legendTextSize, skipnext=1, skipspace=74)
