...
c = canvas(ctype, title='pruning_time', dimensions=[400, 150])


######################################real_time#################################

t = table(file='pruning_time.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.001, 150000], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30], yscale='log10')
...
#          xlabelrotate=20,
        ...
        xlabelshift=[0,0],
         ...
         ymanual=[['0.001', 0.001], ['0.1', 0.1], ['10', 10], ['1000', 1000], ['INFI', 7200]],
...
series_list = ['prune', 'noprune']
series_name = ['GMBE', 'GMBE-W/O_PRUNE']
bgcolors    = ['white', 'white', 'white', 'white', 'white','lightgrey', 'lightgrey', 'black']
fillcolors  = ['black', 'white', 'black', 'black', 'black','black', 'black', 'black',]
...
#### legend
L.draw(canvas=c, coord=[d.left()+40, d.top()+10], skipnext=1, skipspace=45,
