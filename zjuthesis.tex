...
\documentclass[
    ...
    % Title
    Title           = 大规模二分图中的极大二分团枚举方法研究,
    TitleEng        = Research on Maximal Biclique Enumeration in Large Bipartite Graphs
    % Title           = 大规模二分图中的高效极大二分团枚举方法研究,
    % TitleEng        = {{Research of Efficient Maximal Biclique Enumeration in Large Bipartite Graphs}}
]{zjuthesis}

%% Uncomment the following lines if you need multi line titles on cover pages
\titletwolines{大规模二分图中的极大}{二分团枚举方法研究}
\titleengtwolines{Research on Maximal Biclique}{Enumeration in Large Bipartite Graphs}
