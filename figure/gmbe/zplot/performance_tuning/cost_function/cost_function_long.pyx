...
c = canvas(ctype, title='cost_function', dimensions=[600, 150])


######################################real_time#################################

t = table(file='cost_function.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.005, 1000], dimensions=[550, 100], coord=[40,30], yscale='log10')
...
axis(drawable=d, style='box', ticstyle='in',
         ...
         ytitle='Running time (s)', doylabels=True,ytitleshift=[6,-7],
         linewidth=0.8,
         #yaxisposition=1,
...
#          xlabelrotate=20,
        ...
        xlabelshift=[0, 10],
         ...
         xtitlesize=8,
         ytitlesize=8,
         ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], ['10', 10],['100', 100], ['1000', 1000]],#, ['INFI', 7200]],
...
series_list = ['gmbe201000', 'gmbe201500', 'gmbe301500', 'gmbe302500', 'gmbe402500', 'gmbe403500']
series_name = ['GMBE-(20,1000)','GMBE-(20,1500)','GMBE-(30,1500)', 'GMBE-(30,2500)', 'GMBE-(40,2500)', 'GMBE-(40,3500)']
bgcolors    = ['white', 'white', 'white', 'white', 'white','lightgrey', 'lightgrey', 'black']
fillcolors  = ['lightcyan', 'darkgreen', 'lightgreen', 'honeydew', 'palegreen','mintcream', 'black', 'black',]
...
#### legend
L.draw(canvas=c, coord=[d.left()+2, d.top()+10], skipnext=1, skipspace=95, 
