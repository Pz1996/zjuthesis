...
c = canvas(ctype, title='enumerated_vertices', dimensions=[400, 150])


######################################real_time#################################

t = table(file='enumerated_vertices.data')
...
#### legend
L.draw(canvas=c, coord=[d.left()+40, d.top()+10], skipnext=1, skipspace=75,
