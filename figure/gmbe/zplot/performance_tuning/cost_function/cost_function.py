...
c = canvas(ctype, title='cost_function', dimensions=[400, 200])
...
fillcolors  = fig_colors_light#['lightcyan', 'darkgreen', 'lightgreen', 'honeydew', 'palegreen','mintcream', 'black', 'black',]
temp = fillcolors[0]
...
#### legend
L.draw(canvas=c, coord=[d.left(), d.top()+18], skipnext=2, skipspace=86, 
