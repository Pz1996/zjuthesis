...
c = canvas(ctype, title='diffgpus', dimensions=[400, 200])


######################################real_time#################################

t = table(file='diffgpus.data')
...
series_list = ['gmbea100', 'gmbev100', 'gmbe2080ti']
series_name = ['GMBE-A100','GMBE-V100','GMBE-2080Ti']
...
#### legend
L.draw(canvas=c, coord=[d.left(), d.top()+10], skipnext=1, skipspace=91,
