...
c = canvas(ctype, title='overall_time', dimensions=[700, 150])
...
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.002, 300000], dimensions=[pictureWidthLong, 100], coord=[50,30], yscale='log10')
...
#          xlabelrotate=20,
        xaxisposition=0.0015, #yauto=['','',0.5], 
        # xlabelshift=[0, -1],
