...
c = canvas(ctype, title='breakdown_memory', dimensions=[400, 200])


######################################real_time#################################

t = table(file='breakdown_memory.data')
...
#### legend
L.draw(canvas=c, coord=[d.left()+1, d.top()+8], skipnext=1, skipspace=68,
