...
c = canvas(ctype, title='overall_memory', dimensions=[700, 150])


######################################real_time#################################

t = table(file='overall_memory.data')
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[2, 50000], dimensions=[pictureWidthLong, 100], coord=[30,30], yscale='log10')
