...
c = canvas(ctype, title='optimization', dimensions=[400, 150])
...
d = drawable(canvas=c, xrange=[-0.6, t.getmax('rownumber')+0.6],
             yrange=[0.002, 5000], dimensions=[pictureWidthShort, pictureHeight], coord=[40,30], yscale='log10')
...
#          xlabelrotate=20,
     ...
     xaxisposition=0.001, #yauto=['','',0.5], 
        # xlabelshift=[0, -1],
         ...
         ytitlesize=ytitleTextSize,
         ymanual=[['0.01', 0.01], ['0.1', 0.1], ['1', 1], ['10', 10],['100', 100], ['1k', 1000]],
...
fillcolors  = fig_colors_light#['darkgreen', 'lavenderblush', 'lightyellow', 'oldlace', 'azure','black', 'black', 'black',]
...
#### legend
L.draw(canvas=c, coord=[d.left()+22, d.top()+18], skipnext=2, skipspace=135,
