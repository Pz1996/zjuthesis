...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        分类号：           & \uline{\hfill TP391 \hfill}  &
        单位代码：         & \uline{\hfill 10335 \hfill} \\
        密{\quad}级：      & \uline{\hfill 公开 \hfill} &
        学{\quad\quad}号： & \uline{\hfill 12121014 \hfill}
    \end{tabularx}
\end{center}
...
% {\fontsize{16pt}{\baselineskip}\fontfamily{Times New Roman}\selectfont 
% \uline{This \textbf{te}x}t.
% }
